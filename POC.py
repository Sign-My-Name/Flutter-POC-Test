...
def main():
    ...
    while cap.isOpened():
        ...
        image = cv2.flip(image, 1)  # Flip the image horizontally for correct handedness
        ...
        # Return the frame bytes and the label
        yield base64.b64encode(frame_bytes).decode('utf-8') + ',' + label
